    ...
    <div className="w-full h-full flex flex-col items-center">
      <div className=" mb-8">
        ...
        <p className=" font-semibold text-black text-lg text-center">
          Dit is{" "}
          <span className="text-[#0090ff] font-medium">de laatste stap!</span>
        </p>
      </div>
        ...
        <div className="w-full flex">
          <div className="flex-1">
            <label className="flex flex-col gap-2">
              ...
              <select
                name="toepassing"
                className="text-[17px] shadow-md w-full border-[0.5px] outline-none focus:border-[#0090ff] focus:ring-[#0090ff] border-gray-300 ring-gray-300 px-4 py-3 rounded-[6px]"
              >
        ...
        <div>
          <label className="flex flex-col gap-2">
            ...
            <textarea
              ...
              rows={5}
              cols={33}
              className="resize-none shadow-md w-full border-[0.5px] text-gray-600 outline-none focus:border-[#0090ff] focus:ring-[#0090ff] border-gray-300 ring-gray-300 px-3 py-2 rounded-[6px]"
            ></textarea>
          </label>
        </div>
      </div>
