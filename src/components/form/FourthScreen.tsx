...
const FourthScreen = () => {
  return (
    <div className="w-full h-full flex flex-col items-center justify-around px-3">
      ...
      <Check className="w-14 h-14 p-2 rounded-full bg-[#54C247] text-white" size={8} strokeWidth={5} />
        <div className="ml-8">

        <h2 className="text-[#575A64] text-2xl font-extrabold text-start">
          Aanvrag gelukt
        </h2>
        <p className=" font-semibold text-[#808189] text-lg text-start">
          Aangenaam!
        </p>
        </div>
      </div>
      ...
      <div className="w-full flex flex-col gap-5 pb-6">
        <div>
          <h3 className="text-lg font-bold text-[#5A5D64] leading-snug">Email bevestiging</h3>
        ...
        <div>
          <h3 className="text-lg font-bold text-[#5A5D64] leading-snug">Prijsindicatie</h3>
          <p className="font-light text-[#808189] leading-tight">
        ...
        <div>
          <h3 className="text-lg font-bold text-[#5A5D64] leading-snug">Telefonisch contact</h3>
          <p className="font-light text-[#808189] leading-tight">
        ...
        <div>
          <h3 className="text-lg font-bold text-[#5A5D64] leading-snug">Intake gesprek showroom</h3>
          <p className="font-light text-[#808189] leading-tight">
